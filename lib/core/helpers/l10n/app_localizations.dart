...
abstract class AppLocalizations {
  ...
  /// No description provided for @lblUsersList.
  ///
  /// In en, this message translates to:
  /// **'Users List'**
  String get lblUsersList;
  ...
  /// No description provided for @lblFieldIsEmpty.
  ///
  /// In en, this message translates to:
  /// **'Field is empty'**
  String get lblFieldIsEmpty;

  /// No description provided for @lblNoUsers.
  ///
  /// In en, this message translates to:
  /// **'No users found'**
  String get lblNoUsers;

  /// No description provided for @lblUserDetails.
  ///
  /// In en, this message translates to:
  /// **'User Details'**
  String get lblUserDetails;
}
